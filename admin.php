...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `productos`(product_name, product_category, product_type, product_price, product_image) VALUES('$p_name', '$p_category', '$p_type','$p_price', '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `productos` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `productos` SET product_name = '$update_p_name', product_price = '$update_p_price', product_image = '$update_p_image' WHERE id = '$update_p_id'");
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `productos` WHERE id = $edit_id");
